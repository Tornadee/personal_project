...
class AI:
	...
	def _create_model(self):
		model = Sequential()
		model.add(Dense(24, input_dim=self.num_states, activation="relu"))#24,48
	...
	def _save_model(self):	# save h5 model
...
if __name__ == "__main__":
	...
	while AI.episode < AI.max_episodes:
		...
		complete = (env.player.z >= env.platforms[-4].z)
